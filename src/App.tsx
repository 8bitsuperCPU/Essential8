...
function StrategyDetail() {
  ...
  return (<div className="mx-auto max-w-7xl px-4 py-8"><Link to="/" className="inline-flex items-center gap-1 text-sm text-cyber-muted hover:text-cyber-primary mb-6 transition-colors"><ArrowLeft size={14} /> Back</Link><div className="mb-8"><h2 className="text-2xl font-bold text-cyber-text mb-2">{strategy.name}</h2><p className="text-cyber-muted text-sm max-w-3xl">{strategy.description}</p>{strategy.id === 'patch-applications' && <div onClick={() => window.open('/patch-applications.mp4', '_blank', 'width=900,height=600')} className="mt-4 cursor-pointer inline-flex items-center gap-3 rounded-xl border border-cyber-border bg-cyber-bg/50 px-5 py-4 hover:border-cyber-primary/40 transition-colors"><PlayCircle className="text-cyber-primary shrink-0" size={28} /><div><h4 className="text-sm font-bold text-cyber-text">Patch Applications Training Video</h4><p className="text-xs text-cyber-muted">Click to watch: Patch Applications</p></div></div>}
        {strategy.id === 'patch-operating-systems' && <div onClick={() => window.open('/patch-operating-systems.mp4', '_blank', 'width=900,height=600')} className="mt-4 cursor-pointer inline-flex items-center gap-3 rounded-xl border border-cyber-border bg-cyber-bg/50 px-5 py-4 hover:border-cyber-primary/40 transition-colors"><PlayCircle className="text-cyber-primary shrink-0" size={28} /><div><h4 className="text-sm font-bold text-cyber-text">Patch Operating Systems Training Video</h4><p className="text-xs text-cyber-muted">Click to watch: Patch Operating Systems</p></div></div>}
        {strategy.id === 'application-control' && <div onClick={() => window.open('/application-control.mp4', '_blank', 'width=900,height=600')} className="mt-4 cursor-pointer inline-flex items-center gap-3 rounded-xl border border-cyber-border bg-cyber-bg/50 px-5 py-4 hover:border-cyber-primary/40 transition-colors"><PlayCircle className="text-cyber-primary shrink-0" size={28} /><div><h4 className="text-sm font-bold text-cyber-text">Application Control Training Video</h4><p className="text-xs text-cyber-muted">Click to watch: Application Control</p></div></div>}
        {strategy.id === 'application-hardening' && <div onClick={() => window.open('/application-hardening.mp4', '_blank', 'width=900,height=600')} className="mt-4 cursor-pointer inline-flex items-center gap-3 rounded-xl border border-cyber-border bg-cyber-bg/50 px-5 py-4 hover:border-cyber-primary/40 transition-colors"><PlayCircle className="text-cyber-primary shrink-0" size={28} /><div><h4 className="text-sm font-bold text-cyber-text">Application Hardening Training Video</h4><p className="text-xs text-cyber-muted">Click to watch: Application Hardening</p></div></div>}
        {strategy.id === 'multi-factor-authentication' && <div onClick={() => window.open('/mfa.mp4', '_blank', 'width=900,height=600')} className="mt-4 cursor-pointer inline-flex items-center gap-3 rounded-xl border border-cyber-border bg-cyber-bg/50 px-5 py-4 hover:border-cyber-primary/40 transition-colors"><PlayCircle className="text-cyber-primary shrink-0" size={28} /><div><h4 className="text-sm font-bold text-cyber-text">Multi-Factor Authentication Training Video</h4><p className="text-xs text-cyber-muted">Click to watch: Multi-Factor Authentication</p></div></div>}
        {strategy.id === 'restrict-microsoft-office-macros' && <div onClick={() => window.open('/office-macros.mp4', '_blank', 'width=900,height=600')} className="mt-4 cursor-pointer inline-flex items-center gap-3 rounded-xl border border-cyber-border bg-cyber-bg/50 px-5 py-4 hover:border-cyber-primary/40 transition-colors"><PlayCircle className="text-cyber-primary shrink-0" size={28} /><div><h4 className="text-sm font-bold text-cyber-text">Restrict Microsoft Office Macros Training Video</h4><p className="text-xs text-cyber-muted">Click to watch: Office Macros</p></div></div>}
        {strategy.id === 'restrict-administrative-privileges' && <div onClick={() => window.open('/privileges.mp4', '_blank', 'width=900,height=600')} className="mt-4 cursor-pointer inline-flex items-center gap-3 rounded-xl border border-cyber-border bg-cyber-bg/50 px-5 py-4 hover:border-cyber-primary/40 transition-colors"><PlayCircle className="text-cyber-primary shrink-0" size={28} /><div><h4 className="text-sm font-bold text-cyber-text">Restrict Administrative Privileges Training Video</h4><p className="text-xs text-cyber-muted">Click to watch: Restrict Admin Privileges</p></div></div>}
        {strategy.id === 'user-application-hardening' && <div onClick={() => window.open('/application-hardening.mp4', '_blank', 'width=900,height=600')} className="mt-4 cursor-pointer inline-flex items-center gap-3 rounded-xl border border-cyber-border bg-cyber-bg/50 px-5 py-4 hover:border-cyber-primary/40 transition-colors"><PlayCircle className="text-cyber-primary shrink-0" size={28} /><div><h4 className="text-sm font-bold text-cyber-text">User Application Hardening Training Video</h4><p className="text-xs text-cyber-muted">Click to watch: User Application Hardening</p></div></div>}
        {strategy.id === 'regular-backups' && <div onClick={() => window.open('/backups.mp4', '_blank', 'width=900,height=600')} className="mt-4 cursor-pointer inline-flex items-center gap-3 rounded-xl border border-cyber-border bg-cyber-bg/50 px-5 py-4 hover:border-cyber-primary/40 transition-colors"><PlayCircle className="text-cyber-primary shrink-0" size={28} /><div><h4 className="text-sm font-bold text-cyber-text">Regular Backups Training Video</h4><p className="text-xs text-cyber-muted">Click to watch: Regular Backups</p></div></div>}</div><div className="grid grid-cols-1 md:grid-cols-3 gap-4">{strategy.maturityLevels.map(ml => <MaturityCard key={ml.level} strategyId={strategy.id} maturity={ml} />)}</div></div>);
}
